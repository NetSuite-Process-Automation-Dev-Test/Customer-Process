package com.qa.customerCreation.ExtentReportsListeners;
...
public class ExtentReportListener {
	...
	public static ExtentReports setUp() {
		...
		report = new ExtentSparkReporter(System.getProperty("user.dir") + "/Extent_report/Customer Creation Process Automation.html");
		report.config().setDocumentTitle("Customer Creation Process Automation"); // Tile of report
		report.config().setReportName("Customer Creation Process Automation"); // Name of the report
