...
public class ITestListenerImpl extends ExtentReportListener implements ITestListener {
	...
	public void emailToSingleReceipient(String receipient) throws EmailException {
		...
		attachment.setPath("./Extent_report/Customer Creation Process Automation.html");
		...
		email.setSubject("Customer Creation Process Automation Test Report");
		email.setMsg("Hey, Automation testing for Customer creation is completed. Please find the test report below");
