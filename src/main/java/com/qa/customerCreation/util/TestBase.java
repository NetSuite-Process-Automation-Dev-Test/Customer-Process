package com.qa.customerCreation.util;
...
import com.qa.customerCreation.ExtentReportsListeners.ExtentReportListener;
...
public class TestBase extends ExtentReportListener {
	...
	public TestBase() {
		try {
			prop = new Properties();
			FileInputStream fis = new FileInputStream("F:\\Selenium\\CustomerCreationProcessAutomation\\src\\main\\java\\com\\qa\\customerCreation\\config\\config.properties");
			prop.load(fis);
		} catch(IOException e) {
			e.getMessage();
		}
